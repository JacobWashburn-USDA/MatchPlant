...
2. PyTorch Utility Files:
    - coco_eval.py, coco_utils.py, engine.py, transforms.py, and utils.py
  
3. Configuration File (test_config.yaml)

Edit `test_config.yaml` to match your requirements:
...
1. Mean Average Precision (mAP) Metrics:
```
...
5. Size-based Performance Analysis:
```
Small Objects:
