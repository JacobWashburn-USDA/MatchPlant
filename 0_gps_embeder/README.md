...
This project is licensed under the MIT License. For details, see the [LICENSE]([LICENSE](https://github.com/JacobWashburn-USDA/Ortho_to_image/blob/main/LICENSE)) file.
